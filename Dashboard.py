...
def load_data():
    ...
    df_agg = pd.read_csv('C:/Users/mathe/.vscode/Projects/Youtube Data Dashboard with Sreamlit/YT_Dashboard_St/Aggregated_Metrics_By_Video.csv').iloc[1:,:]
    ...
    df_agg_sub = pd.read_csv('C:/Users/mathe/.vscode/Projects/Youtube Data Dashboard with Sreamlit/YT_Dashboard_St/Aggregated_Metrics_By_Country_And_Subscriber_Status.csv')
    df_comments = pd.read_csv('C:/Users/mathe/.vscode/Projects/Youtube Data Dashboard with Sreamlit/YT_Dashboard_St/Aggregated_Metrics_By_Video.csv')
    df_time = pd.read_csv('C:/Users/mathe/.vscode/Projects/Youtube Data Dashboard with Sreamlit/YT_Dashboard_St/Video_Performance_Over_Time.csv')
